// Source: https://www.codeproject.com/Tips/771772/WebControls/Tips/771772/WebControls/
...
namespace Ed
{
    ...
    public class IniFile
    {
        ...
        private bool TryGetValue(string section, string key, out string value)
        {
            ...
            return dictionary.TryGetValue(key2.ToLower(new CultureInfo("en-US", false)), out value);
        }
        ...
        public string[] GetAllValues(string section, string key)
        {
            ...
            if (section.StartsWith("["))
                key2 = String.Format("{0}{1}", section, key).ToLower(new CultureInfo("en-US", false));
            else
                key2 = String.Format("[{0}]{1}", section, key).ToLower(new CultureInfo("en-US", false));
